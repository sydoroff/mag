    ...
    <nav class="mb-1 navbar fixed-top navbar-expand-lg navbar-dark indigo lighten-3 scrolling-navbar">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="/public/admin/products/">Тоавры</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/public/admin/categories/">Каталог</a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-default" aria-labelledby="navbarDropdownMenuLink-333">
                        <a class="dropdown-item" href="/public/admin/orders/">Все</a>
                        <a class="dropdown-item" href="#">Новые</a>
                        <a class="dropdown-item" href="#">Закрытые</a>
                    </div>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/public/admin/users/">Пользователи</a>
                </li>
            </ul>
